export const fallbackCategories = [
  { id: 1, name: "Basics", description: "Introductory Kiswahili essentials" },
  { id: 2, name: "Conversation", description: "Everyday phrases and dialogs" },
  { id: 3, name: "Travel", description: "Travel and navigation vocabulary" },
];
...
export const fallbackLessons = fallbackCourses.flatMap((course) => (
